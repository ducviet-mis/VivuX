  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button variant="ghost" size="icon" aria-label="Cài đặt mục tiêu hằng ngày" className="text-muted-foreground hover:text-foreground">
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 pt-4">
          <div className="space-y-2">
            <label htmlFor="goal-minutes" className="text-sm font-medium">Thời gian học (phút)</label>
            <Input 
              id="goal-minutes" type="number" 
              min={1} 
          ...
          <div className="space-y-2">
            <label htmlFor="goal-questions" className="text-sm font-medium">Số câu hoàn thành</label>
            <Input 
              id="goal-questions" type="number" 
              min={1} 
          ...
          <div className="space-y-2">
            <label htmlFor="goal-accuracy" className="text-sm font-medium">Độ chính xác mục tiêu (%)</label>
            <Input 
              id="goal-accuracy" type="number" 
              min={1} 
              max={100} 
